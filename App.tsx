  ...
  return (
    <section className="relative pt-40 pb-28 px-4 bg-white overflow-hidden min-h-[95vh] flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-slate-50">
        ...
        >
          <div 
            className="w-full h-full rounded-full blur-[140px] md:blur-[220px]"
            style={{ 
              background: 'radial-gradient(circle, #FF4D2E 0%, transparent 70%)',
              animation: 'liquid-drift-1 28s ease-in-out infinite'
            }}
          />
        </div>
        
        {/* Blob 2: Dark Warm Red (#C0392B) */}
        <div 
        ...
        >
          <div 
            className="w-full h-full rounded-full blur-[160px] md:blur-[260px]"
            style={{ 
              background: 'radial-gradient(circle, #C0392B 0%, transparent 75%)',
              animation: 'liquid-drift-2 38s ease-in-out infinite'
            }}
          />
        </div>
        ...
        <div 
          className="liquid-blob absolute w-[110vw] h-[110vw] md:w-[60vw] md:h-[60vw] top-[15%] right-[15%] opacity-20 mix-blend-multiply"
          style={{ 
            transform: `translate3d(${mousePos.x * 300}px, ${mousePos.y * -150}px, 0)`,
          }}
        >
          <div 
            className="w-full h-full rounded-full blur-[180px] md:blur-[300px]"
            style={{ 
              background: 'radial-gradient(circle, #FF4D2E 0%, transparent 80%)',
              animation: 'liquid-drift-1 22s reverse infinite'
            }}
          />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
            Lo que puedes lograr con BetterCode
          </h2>
          ...
          <p className="mt-10 text-xl md:text-2xl font-bold text-slate-400 tracking-tight">
            Web real. Deploy real. Sin saber código.
          </p>
        ...
        <div className="relative flex justify-center items-center mb-24 max-w-4xl mx-auto">
          ...
          <div className="relative flex justify-between w-full">
            <div className="flex flex-col items-center gap-4">
              <div className="w-20 h-20 rounded-full bg-accent text-white flex items-center justify-center font-black text-xl shadow-[0_0_40px_rgba(255,77,46,0.5)] z-10 border-4 border-[#0B0B0B] transition-transform hover:scale-110">
                Hoy
              </div>
            </div>
            <div className="flex flex-col items-center gap-4">
              <div className="w-20 h-20 rounded-full bg-slate-800 text-slate-500 flex flex-col items-center justify-center font-black text-lg leading-[0.85] z-10 border-4 border-[#0B0B0B] transition-transform hover:scale-110 text-center">
                <span>Clase</span>
                <span>2</span>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-24">
          ...
          <div className="bg-[#141414] border border-white/10 p-10 rounded-[3rem] flex flex-col h-full hover:border-accent/50 transition-all group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-black mb-10 text-white group-hover:text-accent transition-colors leading-tight">
              Diseña tu web con base real
            </h3>
            <ul className="space-y-6 mb-12 flex-grow">
              {[
                "Definir logo y paleta de colores",
                "Moodboard visual en Pinterest",
                "Site diagram (flujo de la web) usando IA",
                "Diseño completo en Figma (desktop + mobile)"
              ].map((text, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-400 font-bold leading-relaxed">
            ...
            <div className="pt-8 border-t border-white/10 mt-auto">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Outcome garantizado:</p>
              <p className="text-lg font-extrabold text-white leading-snug">"Sales con: diseño listo para pasar a código"</p>
            </div>
          </div>
          ...
          <div className="bg-[#141414] border border-white/10 p-10 rounded-[3rem] flex flex-col h-full hover:border-accent/50 transition-all group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 blur-3xl rounded-full"></div>
            <h3 className="text-2xl font-black mb-10 text-white group-hover:text-accent transition-colors leading-tight">
              Convierte tu diseño en una web online
            </h3>
            <ul className="space-y-6 mb-12 flex-grow">
              {[
                "Pasar Figma a web usando IA",
                "Iterar el diseño con prompteo",
                "Subir el proyecto a GitHub",
                "Deploy en Vercel con link público"
              ].map((text, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-400 font-bold leading-relaxed">
                  <CheckCircle2 size={22} className="text-accent shrink-0 mt-1" />
                  {text}
            ...
            <div className="pt-8 border-t border-white/10 mt-auto">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Outcome garantizado:</p>
              <p className="text-lg font-extrabold text-white leading-snug">"Sales con: tu web deployada y funcional"</p>
            </div>
          </div>

          {/* Card 3 */}
          <div className="bg-[#141414] border border-white/10 p-10 rounded-[3rem] flex flex-col h-full hover:border-accent/50 transition-all group relative overflow-hidden">
            <div className="absolute -top-4 -right-4 w-40 h-40 bg-accent/10 blur-3xl rounded-full"></div>
            <div className="mb-6 inline-flex px-4 py-1.5 bg-accent/20 border border-accent/30 rounded-full text-xs font-black text-accent uppercase tracking-widest">
              Nivel Avanzado
            </div>
            <h3 className="text-2xl font-black mb-10 text-white group-hover:text-accent transition-colors leading-tight">
              Navegación, pagos y escalado
            </h3>
            <ul className="space-y-6 mb-12 flex-grow">
              {[
                "Paginación y corrección de navegación",
                "Mejora de estructura y experiencia",
                "Integración de links de pago",
                "Versionado de tu web"
              ].map((text, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-400 font-bold leading-relaxed">
                  <CheckCircle2 size={22} className="text-accent shrink-0 mt-1" />
                  {text}
            ...
            <div className="pt-8 border-t border-white/10 mt-auto">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Outcome garantizado:</p>
              <p className="text-lg font-extrabold text-white leading-snug">"Sales con: web lista para vender"</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center flex flex-col items-center">
          <a href="#precios" className="group relative bg-accent text-white px-16 py-8 rounded-[2.5rem] text-3xl font-black hover:scale-105 transition-all shadow-[0_20px_60px_rgba(255,77,46,0.3)] hover:shadow-accent/40">
            Elegir mis clases
          </a>
          <p className="mt-10 text-slate-400 font-bold text-xl tracking-tight">
            Clase individual $12 · Pack 2 $15 · <span className="text-white border-b-2 border-accent pb-1">Pack completo $22</span>
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-sm">
            <h3 className="text-2xl font-bold mb-8 flex items-center gap-2 text-emerald-600">
              <CheckCircle2 size={24} /> Es para ti si…
            </h3>
          ...
          <div className="bg-slate-100 p-10 rounded-[2.5rem] border border-slate-200 shadow-inner">
            <h3 className="text-2xl font-bold mb-8 flex items-center gap-2 text-slate-400">
              <XCircle size={24} /> No es para ti si…
            </h3>
            <ul className="space-y-6">
              {[
...
const Pricing = () => {
  const packs = [
    ...
    },
    {
      ...
      includes: [
        "Acceso a 2 clases 100% en vivo",
        "Material de apoyo práctico",
        "Material complementario: comparativas de herramientas y costos",
        "Acceso al grupo privado de WhatsApp"
      ],
      recommended: false,
      savings: "Ahorra 37%"
    },
    {
      ...
      includes: [
        "Acceso a 3 clases 100% en vivo",
        "Material de apoyo paso a paso",
        "Material complementario: comparativas, decisiones y recomendaciones para despegar",
        "Acceso al grupo privado de WhatsApp",
    ...
    <section className="py-24 px-4 bg-[#0B0B0B] text-white overflow-hidden relative" id="precios">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-stretch">
          {packs.map((pack, i) => (
            <div key={i} className={`
              relative p-8 rounded-[2.5rem] flex flex-col transition-all
              ${pack.recommended 
                ? 'bg-slate-900 text-white ring-4 ring-accent shadow-2xl scale-105 z-10 border border-accent/20' 
                : 'bg-white/5 border border-white/10 text-white hover:border-white/20'}
            `}>
              {pack.recommended && (
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-accent text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest whitespace-nowrap">
                  EL MÁS POPULAR
                </div>
              )}

              {pack.savings && (
                <div className={`absolute top-6 right-8 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${pack.recommended ? 'bg-white text-slate-900' : 'bg-accent text-white'}`}>
                  {pack.savings}
                </div>
              )}
              ...
              <p className={`text-sm font-bold mb-8 ${pack.recommended ? 'text-slate-300' : 'text-slate-400'}`}>
                {pack.ideal}
              </p>

              <div className="space-y-4 mb-10 flex-grow">
                <p className="text-[10px] font-black uppercase tracking-widest opacity-40">Qué incluye:</p>
              ...
              <button className={`
                ...
                ${pack.recommended 
                  ? 'bg-accent text-white hover:bg-[#E64529]' 
                  : 'bg-white text-slate-900 hover:bg-slate-200'}
              `}>
                Elegir este plan (${pack.price})
              </button>
            </div>
          ))}
        </div>
...
const Results = () => {
  const outcomes = [
    {
      title: "Tu primera web real, funcionando hoy mismo",
      description: "Olvídate de plantillas genéricas: tendrás una web propia bajo un dominio free o puedes ponerle uno propio, lista para mostrar al mundo."
    },
    {
      title: "Control total sin escribir código",
      description: "Aprende a manejar tu web y tu repositorio como un pro, sin necesidad de saber programar ni complicarte con líneas de código."
    },
    {
      title: "Diseño profesional hecho a medida",
      description: "Tu web se verá moderna y profesional, creada para ti y tu negocio."
    },
    {
      title: "Actualizaciones rápidas con IA",
      description: "Cambia textos, imágenes o secciones en segundos usando prompts de IA: nada de esperar a un diseñador o desarrollador."
    },
    {
      title: "Metodologías 100% replicables, cuantas veces quieras",
      description: "Podrás repetir los procesos y crear nuevas páginas o proyectos con la misma técnica, sin empezar de cero ni depender de nadie."
    },
    {
      title: "Independencia total",
      description: "Nunca más dependerás de terceros para cambios básicos. Tu web será tuya, tú la controlas y tú la actualizas."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-950 mb-4">
            Resultados reales desde la 2 clase
          </h2>
        </div>
  ...
  return (
    <div className="border-b border-white/10">
      <button 
        ...
        className="w-full py-6 flex justify-between items-center text-left hover:text-accent transition-colors text-white"
      >
      ...
      <div className={`overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-[600px] pb-6' : 'max-h-0'}`}>
        <p className="text-slate-400 font-semibold leading-relaxed text-lg whitespace-pre-line">{answer}</p>
      </div>
    </div>
  );
};
...
const FAQ = () => {
  const faqs = [
    {
      question: "¿De verdad no pago nada por herramientas?",
      answer: "Correcto. Usamos los planes gratuitos de Figma, GitHub, Vercel y AI Studio. Estos planes son increíblemente generosos y suficientes para proyectos profesionales hasta que tengas miles de visitas."
    },
    {
      question: "¿Necesito saber diseño o código previamente?",
      answer: "No. Empezamos desde lo más básico de la lógica visual y técnica. La IA se encarga del trabajo pesado, tú te encargas de la dirección y la lógica del negocio."
    },
    {
      question: "¿Qué pasa si no tengo logo ni marca?",
      answer: "La Clase 1 está diseñada precisamente para eso. Aprenderás a usar IA y herramientas gratuitas para crear una identidad visual decente en minutos."
    },
    {
      question: "¿Esto es un ecommerce como Shopify?",
      answer: "No. Es una estructura frontend moderna con páginas dinámicas y links de pago asociados. Perfecto para vender productos sin gestionar backend, inventario o historial complejo."
    },
    {
      question: "¿Sirve para vender productos reales?",
      answer: "Sí. En la Clase 3 aprenderás a crear páginas dinámicas por producto y a asociar links de pago (Stripe, Gumroad u otros).\n\nNo es un ecommerce con backend tipo Shopify o WordPress, sino una estructura moderna y ligera, ideal para vender sin complicaciones técnicas.\n\n👉 Si tienes productos estáticos y sin rotación, este enfoque te sirve perfecto.\n\n👉 Si tienes más de 10–15 productos, igual puedes tomar el curso: veremos cómo evaluar costos, tarifas y plataformas de pago para que elijas la mejor opción según tu caso."
    }
  ];
  ...
  return (
    <section className="py-24 px-4 bg-[#0B0B0B]" id="faq">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl font-extrabold text-center mb-16 tracking-tight text-white">Preguntas Frecuentes</h2>
...
const CTAFinal = () => {
  ...
  return (
    <section className="py-24 px-4 bg-white">
      <div className="max-w-5xl mx-auto bg-accent rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-accent/30">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <Zap size={400} className="absolute -top-40 -left-40 rotate-12" />
          <Zap size={300} className="absolute -bottom-20 -right-20 -rotate-12" />
        </div>
        
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight">
            No pierdas otro año con una web "en construcción".
          </h2>
          <p className="text-xl md:text-2xl font-bold mb-12 opacity-90 max-w-2xl mx-auto">
            Únete a BetterCode y lanza tu proyecto real. Garantizado: si sigues el proceso, sales con tu web publicada.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="#precios" className="w-full sm:w-auto bg-white text-accent px-10 py-6 rounded-2xl text-xl font-black hover:scale-105 transition-all shadow-xl">
              Quiero el pack completo ($22)
            </a>
            ...
            <a 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-3 bg-slate-900/20 hover:bg-slate-900/40 px-10 py-6 rounded-2xl transition-all border border-white/20"
            >
              <MessageCircle size={24} className="fill-white text-slate-900" />
              <span className="font-extrabold text-xl">Tengo más dudas</span>
            </a>
          </div>
        </div>
      </div>
  ...
  return (
    <footer className="py-12 border-t border-slate-100 bg-white">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-2">
          <Zap className="text-accent fill-accent" size={24} />
          <span className="font-extrabold text-xl text-slate-900">BetterCode</span>
        </div>
        <div className="text-slate-400 font-bold text-sm">
          © {new Date().getFullYear()} BetterCode. Sin humo. Solo código y despliegues reales.
        </div>
        <div className="flex gap-6 text-slate-400">
          <Github size={20} className="hover:text-slate-900 cursor-pointer transition-colors" />
          <Figma size={20} className="hover:text-slate-900 cursor-pointer transition-colors" />
          <ShoppingBag size={20} className="hover:text-slate-900 cursor-pointer transition-colors" />
        </div>
      </div>
    </footer>
  );
